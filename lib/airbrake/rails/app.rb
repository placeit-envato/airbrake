      ...
      def self.recognize_route(request)
        ...
        engines.each do |engine|
          engine.routes.router.recognize(request_copy) do |route, _params|
            ...
            #
            # Placeit is not on Rails 7 and this line in the original gem caused
            # issues for some devs in local. Reverting this line to its original
            # form in earlier gem versions.
